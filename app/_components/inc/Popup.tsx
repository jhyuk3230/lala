				...
				<div>
					<form action="">
						<div className="popup__input">
							<label htmlFor="id" className="w-[80px] inline-block align-bottom leading-[30px]">
								아이디
							</label>
							...
							<label htmlFor="pw" className="w-[80px] mt-4 inline-block align-bottom leading-[30px]">
								비밀번호
							</label>
						...
						<div className="popup__other mt-4 flex justify-between items-center">
							...
							<label htmlFor="autoLogin" className="pr-4 text-[12px] relative">
								로그인 유지
							</label>
							<Link href="#none" className="text-[14px]">
								비밀번호를 잊어버리셨나요?
							</Link>
						</div>

						<div className="popup__btn mt-8">
							<button className="w-full h-10 rounded-[40px] bg-[#FF5566] text-center text-[16px] font-bold text-white" onClick={onLogin}>
								로그인
							</button>
						</div>
					</form>
