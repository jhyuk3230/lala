  ...
  return (
    <footer>
      <section className="pt-2 pb-2 sm:py-2 bg-gray-200">
				<article className="max-w-[1000px] w-full m-auto px-4 sm:flex sm:justify-between sm:items-center">
			...
			<section>
				<article className="max-w-[1000px] w-full m-auto p-4 text-center">
